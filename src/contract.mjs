...
export const TRANSACTIONAL_COMMANDS = Object.freeze([
  'add', 'apply', 'endcard', 'fade', 'grade', 'keyframe', 'layout', 'localize', 'logo', 'motion', 'music',
...
export const TOOL_OPTIONS = Object.freeze({
  ...
  find: Object.freeze(['--boxes', '--context', '--focus', '--kind', '--media', '--min-score', '--moments',
    '--refresh', '--region', '--says', '--settle', '--shows', '--strip']),
});
